  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (action === "list") {
      ...
      for (const tID of data.activeGroups) {
        ...
        listMsg += `𝐆𝐫𝐨𝐮𝐩 𝐍𝐚𝐦𝐞: ${info.threadName || '𝐔𝐧𝐤𝐧𝐨𝐰𝐧'} 🕊💖\n𝐔𝐢𝐝: ${tID}\n\n`;
      }
      
      const session = moment.tz("Asia/Dhaka").format("HH") < 12 ? "𝐌𝐨𝐫𝐧𝐢𝐧𝐠 🌄" : "𝐀𝐟𝐭𝐞𝐫𝐧𝐨𝐨𝐧 🏜";
      listMsg += `𝐇𝐄𝐑𝐄 𝐈𝐒 𝐘𝐎𝐔𝐑 𝐓𝐂𝐏 𝐀𝐃𝐃𝐄𝐃 𝐆𝐑𝐎𝐔𝐏 𝐋𝐈𝐒𝐓\n\n𝐇𝐚𝐯𝐞 𝐚 𝐧𝐢𝐜𝐞 ${session}\n⚠ 𝐏𝐥𝐞𝐚𝐬𝐞 𝐟𝐨𝐥𝐥𝐨𝐰 𝐚𝐥𝐥 𝐫𝐮𝐥𝐞𝐬 ♻\n\n𝐀𝐝𝐦𝐢𝐧: 𝐌𝐫.𝐊𝐢𝐧𝐠\n𝐅𝐁: 𝐓𝐀𝐖𝐇𝐈𝐃 𝐈𝐒𝐋𝐀𝐌`;
      
      return api.sendMessage(listMsg, threadID, messageID);
    }

    return api.sendMessage("𝐈𝐧𝐯𝐚𝐥𝐢𝐝! 𝐔𝐬𝐞: /tcp add | /tcp remove | /tcp list", threadID, messageID);
  }
};